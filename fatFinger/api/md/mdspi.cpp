...
void CtpMdSpi::setDPMarketDataField(
...
CThostFtdcDepthMarketDataField *CtpMdSpi::getDPMarketDataField(
  ...
  if (mapPCurrentDepthMarketData.find(InstrumentID) !=
      mapPCurrentDepthMarketData.end()) {
...
void CtpMdSpi::OnRtnDepthMarketData(
  ...
  if (PTHREADCONDS.find(InstrumentID) != PTHREADCONDS.end()) {
    ...
    createThread *ct =
        new createThread(&PTHREADCONDS[InstrumentID], pDepthMarketData);
